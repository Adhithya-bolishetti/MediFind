...
public class AppointmentServiceImpl implements AppointmentService {
    ...
    public AppointmentResponse createAppointment(AppointmentRequest request, Long userId) {
        ...
        DoctorAvailabilityResponse availability = objectMapper.convertValue(doctorService.getDoctorAvailability(request.getDoctorId()), DoctorAvailabilityResponse.class);
    ...
    private AppointmentResponse mapToResponse(Appointment appointment) {
        ...
        try {
            user = objectMapper.convertValue(userRepository.findById(appointment.getUserId()).orElse(null), UserResponse.class);
        } catch (Exception e) {
            // Ignore or log
        }
