package com.medifind.appointment.util;
...
/**
 * Parsing helpers for doctor availability configuration (mirror of the
 * doctor-service utility — microservices cannot share a common module).
 *
 * Working days may be stored as full names ("MONDAY,TUESDAY"), abbreviations
 * ("Mon,Tue,Fri"), ranges ("Mon-Sat", "MON-FRI") or mixed. Times may be 24h
 * ("09:00", "17:00") or 12h ("05:00 PM", "9:00AM").
 */
