...
public class HospitalReviewServiceImpl implements HospitalReviewService {
    ...
    public HospitalReviewResponse createReview(Long hospitalId, HospitalReviewRequest request, Long patientId) {
        ...
        try {
            Map<String, Object> appointment = objectMapper.convertValue(appointmentService.getAppointmentById(request.getAppointmentId()), new com.fasterxml.jackson.core.type.TypeReference<java.util.Map<String, Object>>() {});
            if (appointment == null) {
            ...
            Map<String, Object> doctor = objectMapper.convertValue(doctorService.getDoctorById(appDoctorId.longValue()), new com.fasterxml.jackson.core.type.TypeReference<java.util.Map<String, Object>>() {});
            if (doctor == null) {
