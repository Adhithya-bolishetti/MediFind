...
public class DoctorServiceImpl implements DoctorService {
    ...
    public AvailableSlotResponse getAvailableSlots(Long doctorId, String date) {
        ...
        try {
            bookedSlots = appointmentService.getBookedSlots(doctorId, date);
        } catch (Exception e) {
    ...
    public ReviewResponse createReview(Long doctorId, ReviewRequest request, Long userId) {
        ...
        try {
            appointment = objectMapper.convertValue(appointmentService.getAppointmentById(request.getAppointmentId()), new com.fasterxml.jackson.core.type.TypeReference<java.util.Map<String, Object>>() {});
        } catch (Exception e) {
            if (e instanceof org.springframework.web.server.ResponseStatusException && ((org.springframework.web.server.ResponseStatusException)e).getStatusCode() == org.springframework.http.HttpStatus.NOT_FOUND) {
        ...
        return allDoctors.stream()
                ...
                .map(d -> {
                    ...
                    if (d.getHospitalId() != null) {
                        try {
                            HospitalResponse h = objectMapper.convertValue(hospitalService.getHospitalById(d.getHospitalId()), com.medifind.doctor.dto.HospitalResponse.class);
    ...
    private ReviewResponse mapToReviewResponse(Review review) {
        ...
        try {
            UserResponse user = objectMapper.convertValue(userRepository.findById(review.getUserId()).orElse(null), com.medifind.doctor.dto.UserResponse.class);
    ...
    private DoctorResponse mapToDoctorResponse(Doctor doctor) {
        ...
        if (doctor.getHospitalId() != null) {
            try {
                hospitalInfo = objectMapper.convertValue(hospitalService.getHospitalById(doctor.getHospitalId()), com.medifind.doctor.dto.HospitalResponse.class);
            } catch (Exception e) {
