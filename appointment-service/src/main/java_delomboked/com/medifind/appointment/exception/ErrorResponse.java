...
public class ErrorResponse {
    ...
    public static class ErrorResponseBuilder {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ErrorResponse.ErrorResponseBuilder timestamp(final LocalDateTime timestamp) {
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ErrorResponse.ErrorResponseBuilder status(final int status) {
            this.status = status;
            return this;
        }
         ...
         */
        @java.lang.SuppressWarnings("all")
        public ErrorResponse.ErrorResponseBuilder path(final String path) {
            this.path = path;
            return this;
        }
        ...
        public ErrorResponse build() {
            return new ErrorResponse(this.timestamp, this.status, this.message, this.path);
        }

        @java.lang.Override
        @java.lang.SuppressWarnings("all")
        public java.lang.String toString() {
            return "ErrorResponse.ErrorResponseBuilder(timestamp=" + this.timestamp + ", status=" + this.status + ", message=" + this.message + ", path=" + this.path + ")";
        }
    }
    ...
    @java.lang.SuppressWarnings("all")
    public java.lang.String toString() {
        return "ErrorResponse(timestamp=" + this.getTimestamp() + ", status=" + this.getStatus() + ", message=" + this.getMessage() + ", path=" + this.getPath() + ")";
    }
