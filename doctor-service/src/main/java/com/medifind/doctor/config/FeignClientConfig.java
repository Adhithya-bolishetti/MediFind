package com.medifind.doctor.config;
 ...
 * to downstream service calls (Hospital Service).
 * This ensures that the hospital-service can also authenticate the request.
 */
@Configuration
@Slf4j
